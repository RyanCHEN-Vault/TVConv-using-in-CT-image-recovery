...
class TVConv(nn.Module):
    def __init__(self,
        ...
        self.posi_map = nn.Parameter(torch.Tensor(1, TVConv_posi_chans, h, w))  # nn.Parameter参数可训练化
...
class TVConvInvertedResidual(nn.Module):
    def __init__(self, inp, oup, h_w, stride, expand_ratio=6, norm_layer=None, **kwargs):
