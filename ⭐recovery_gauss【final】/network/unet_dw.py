...
class UNet_dw(nn.Module):
    def __init__(self,num_classes):
        ...
        self.c1 = DWConv_Block(3,64,256)  # in_channel = 3, out_channel = 64
        self.d1 = DownSample(64)
        self.c2 = DWConv_Block(64,128,128)
        self.d2 = DownSample(128)
        self.c3 = DWConv_Block(128,256,64)
        self.d3 = DownSample(256)
        self.c4 = DWConv_Block(256,512,32)
        self.d4 = DownSample(512)

        self.c5 = DWConv_Block(512,1024,16)

        self.u1 = UpSample(1024)
        self.c6 = DWConv_Block(1024,512,32)
        self.u2 = UpSample(512)
        self.c7 = DWConv_Block(512,256,64)
        self.u3 = UpSample(256)
        self.c8 = DWConv_Block(256,128,128)
        self.u4 = UpSample(128)
        self.c9 = DWConv_Block(128,64,256)
